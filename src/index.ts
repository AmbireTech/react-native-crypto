...
import installer from './NativeAmbireCrypto';
...
export * from './generated/ambire_crypto';

// Now import the bindings so we can:
// - intialize them
// - export them as namespaced objects as the default export.
import * as ambire_crypto from './generated/ambire_crypto';
...
if (!initialized) {
  ambire_crypto.default.initialize();
  initialized = true;
}
